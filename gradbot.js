...
var simState = {
    ...
    robotStartHeading: 0,
    pacmanStartHeading: 4.71239,    //ADDED BY GAVIN
    opponentStartX: 700,
    opponentStartY: 500,
...
function simulationReset(event) {
    ...
    if(simState.mazeWorldLoaded == true){
        robot.moveTo(simState.robotCombatStartX, simState.robotMazeStartY);
        robot.face(simState.robotStartHeading);
    }
    else if(simState.combatWorldLoaded == true){
        robot.moveTo(simState.robotCombatStartX, simState.robotCombatStartY);
        robot.face(simState.robotStartHeading);
    }
    else if(simState.pacmanWorldLoaded == true){
        robot.moveTo(simState.robotPacmanStartX, simState.robotPacmanStartY);
        robot.face(simState.pacmanStartHeading);
    }
    else {
...
function loadCombatWorld() {
    ...
    robot.heading = 0;      //Added by Gavin 03/22/2023
