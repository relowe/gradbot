    ...
    this.update = function() 
    {
        ...
        switch(simulationMode) {
            case 'toroidal':
                ...
                //GAVIN MOVED THE IF STATEMENTS HERE 04/30/2023
                if(this.x <= -40) {
                    this.x = wxmax-1;
                }
                if(this.y <= -40) {
...
function RangeSensor(parent, x, y) {
    ...
    this.updateSensor = function() {
        ...
        for(var i in objects) {
            ...
            console.log("dist.distance = " + dist.distance)
...
function LaserBlast(x, y, heading, firedBy) {
    ...
    this.vanish = function() {
        ...
        var toRemove = 10000000000;     //GAVIN EDITED 04/12/2023 Originally was -1, but this broke the combat world.
        for(var i = 0; i< simState.worldObjects.length; i++) {
...
function applyEditor(state) {
    ...
    //set the fields
    //GAVIN ADDED 04/30/2023
    if (part.type == "Marker"){
        part.color = fill;
    }
    //END OF GAVIN ADDEDD 04/30/2023
    part.fill = fill;
    part.outline = outline;
    part.name = name;
...
function simulationGo(event) {
    ...
    //BEGINNING OF GAVIN EDITED 04/23/2023
    ...
    //END OF GAVIN EDITED 04/23/2023
...
function simulationReset(event) {
    ...
    if (robot.blowedUp == true){
        ...
        robot.resetLaserBattery();
        robot.hp = 3;
        robotStartingLocation();    //ADDED BY GAVIN 04/12/2023
    }  
...
function gradbotInit() {
    ...
    document.getElementById("Pacbot").onclick = loadPacbot;
    document.getElementById("Destroyer").onclick = loadDestroyer;
    document.getElementById("Theseus").onclick = loadTheseus;
...
function openRobotFile() {
    ...
    reader.onload = function() {
        ...
        robotStartingLocation();    //GAVIN ADDED 04/19/2023
        //redraw
        graphPaperFill("simbg");
        drawSim();
        drawBuild();
